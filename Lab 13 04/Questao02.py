...
class App() :
    ...
    def Executar(self) : 
        ...
        #questão 2)
        if (self.int01 > self.int02) :   
            label_var.set(f'{self.int01} é maior que {self.int02}')
        elif (self.int01 < self.int02) :
            label_var.set(f'{self.int02} é maior que {self.int01}')
        elif (self.int01 == self.int02) :
            label_var.set(f'{self.int02} e {self.int01} são iguais')
