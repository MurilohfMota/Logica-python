...
class App():
    ...
    def Construtor_botões(self):
        #botâo de executar
        self.bt_executar = Button(self.frame_1, text = 'Executar', bd = 2 , bg = '#184e77', fg = '#d9ed92', font = ('firacode', 12))
        self.bt_executar.place ( relx = 0.9, rely = 0.85, relwidth = 0.1, relheight = 0.15)
        #botão proximo
        self.bt_proximo = Button(self.root, text = 'Proximo', bd = 2 , bg = '#52b69a', fg = '#184e77', font = ('firacode', 12))
        self.bt_proximo.place ( relx = 0.89, rely = 0.87, relwidth = 0.1, relheight = 0.07)
        #botão sair
        self.bt_proximo = Button(self.root, text = 'Sair', bd = 2 , bg = '#99d98c', fg = '#184e77', font = ('firacode', 12))
    ...
    def Caixa_texto(self) :
        ...
        self.texto = Label(self.frame_1, text = "Informe dois números inteiros e um número real.", background = '#d9ed92', fg = '#184e77', font = ('firacode', 12))
        ...
        self.texto_resultado = Label(self.frame_2, text = "", background = '#d9ed92')
